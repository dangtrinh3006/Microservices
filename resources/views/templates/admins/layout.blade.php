...
<head>
    ...
    <link rel="icon" href="{!! asset('admin_asset/img/icons/logo.png') !!}" />
...
@if(session()->has('permision'))
    ...
    window.addEventListener('load', (e) => {
        toastr.warning("{{session()->get('permision')}}");
    })
    </script>
    @endif
<body>
        ...
        <nav id="sidebar" class="sidebar js-sidebar">
            <div class="sidebar-content js-simplebar">
                <a class="sidebar-brand" href="{{ route('showDashboard') }}">
                    <span class="align-middle">Good Food</span>
                </a>
                <ul class="sidebar-nav" id="menuAdmin">
                    ...
                    <li class="sidebar-item">
                        ...
                        <i class="fa fa-list-ul" aria-hidden="true"></i>
                            <span class="align-middle">Danh mục thực đơn</span>
                        </a>
                    </li>
                    ...
                    <li class="sidebar-item" value="product">
                        ...
                        <i class="fa fa-cutlery" aria-hidden="true"></i>
                            <span class="align-middle">Thực đơn</span>
                        </a>
                    </li>
                    ...
                    <li class="sidebar-item">
                        ...
                        <i class="fa fa-users" aria-hidden="true"></i>
                            <span class="align-middle">Nhân sự</span>
                        </a>
                    </li>
